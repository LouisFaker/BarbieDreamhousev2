      ...
      <footer id="footer">
        <div className="footer-content">
          ...
          <ul className="footer-menu">
            ...
            <li className="footer-menu-item">Viaje junto a Louis Airlines</li>
          ...
          <div className="socials">
            ...
            <a href="https://www.facebook.com/profile.php?id=100082210016307" target="_blank">
        ...
        <div className="footer-info">
          ...
          <div className="rights">
            <div className="country">
              <p>España</p>
              <img src="img/espana.png" alt="" className="brazil-flag" />
            </div>
            <p>&copy; 2022 Louis Airlines AB</p>
          </div>
        </div>
      </footer>
    );
